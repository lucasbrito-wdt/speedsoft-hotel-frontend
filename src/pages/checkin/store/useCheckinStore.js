    ...
    actions: {
        ...
        async search(state) {
            ...
            if (this.searchTerm.field && this.searchTerm.search) {
                await CheckinService.search(this.searchTerm.field, this.searchTerm.search, this.searchPage, this.searchTerm.relationship, this.orderBy)
                    .then(res => {
                    if (res.data.length === 0) {
                        state.complete();
                    }
...
//# sourceMappingURL=useCheckinStore.js.map